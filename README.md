...
1. Install [Terraform](https://developer.hashicorp.com/terraform/install) 1.15
...
1. Run the database image:
   ...
   ```bash
   docker run --rm -it -e POSTGRES_USER=ate -e POSTGRES_PASSWORD=password -p 5432:5432 postgres:18
   ```
