...
class TestCapitalSchemeSchemeStatusEntity:
    def test_from_domain(self) -> None:
        ...
        assert (
            ...
            and scheme_status_entity.effective_date_from == local_datetime(2020, 1, 1)
    ...
    def test_from_domain_when_historic(self) -> None:
        ...
        assert scheme_status_entity.effective_date_to == local_datetime(2020, 2, 1)
    ...
    def test_from_domain_converts_dates_to_local_europe_london(self) -> None:
        ...
        assert scheme_status_entity.effective_date_from == local_datetime(2020, 6, 1, 13)
        assert scheme_status_entity.effective_date_to == local_datetime(2020, 7, 1, 13)
