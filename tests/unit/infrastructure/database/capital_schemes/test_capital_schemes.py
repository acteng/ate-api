...
class TestDatabaseCapitalSchemeRepository:
    ...
    def test_get_references_by_bid_submitting_authority_filters_by_current_milestones(self, engine: Engine) -> None:
        with Session(engine) as session, session.begin():
            session.add_all(
                [
                    liv := AuthorityEntity(authority_full_name="Liverpool", authority_abbreviation="LIV"),
    ...
    def test_get_references_by_bid_submitting_authority_selects_current_milestone(self, engine: Engine) -> None:
        with Session(engine) as session, session.begin():
            session.add_all(
                [
                    liv := AuthorityEntity(authority_full_name="Liverpool", authority_abbreviation="LIV"),
